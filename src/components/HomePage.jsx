        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8">
              Access previous question papers and contribute to help fellow
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 lg:min-h-20">
              ...
              {user?.role === "admin" && (
                <button
                  ...
                  onMouseLeave={() => setActiveHover(null)}
                  className="relative overflow-hidden not-md:w-full bg-gradient-to-r from-purple-300 via-purple-500 to-purple-700 text-white 
        px-6 py-4 rounded-xl shadow-lg hover:shadow-2xl group transition-all duration-300 w-80
        hover:scale-105 transform"
                >
                  <div className="flex items-center justify-center space-x-3 relative z-10">
                    <Star
                      className={`w-6 h-6 transition-all duration-300 ${activeHover === "special" ? "transform rotate-180" : ""}`}
                    />
                    <span className="font-semibold text-lg">Verify Papers</span>
                    <ArrowRight
                      className={`w-5 h-5 transition-all duration-300 opacity-0 ${activeHover === "special" ? "transform translate-x-1 opacity-100" : ""}`}
                    />
                  </div>
            ...
            <div className="flex flex-col items-center justify-center h-full relative z-10">
              ...
              <div className="text-center">
                ...
                <p className="text-black/90 mb-6">
                  Prepare better with previous exam papers
                </p>
