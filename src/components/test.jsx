      ...
      {d && (
        <main className="mx-auto max-w-3xl px-6 py-10 text-[20px] leading-relaxed">
          ...
          <table className="mt-3 w-full border-collapse border border-black text-center text-[18px]">
            ...
            <tbody>
              <tr>
                <td className="border border-black px-3 py-2">{d["ltpc"][0]}</td>
                <td className="border border-black px-3 py-2">{d["ltpc"][1]}</td>
                <td className="border border-black px-3 py-2">{d["ltpc"][2]}</td>
                <td className="border border-black px-3 py-2">{d["ltpc"][3]}</td>
                <td className="border border-black px-3 py-2">
                  {d["contactHours"]}
                </td>
              </tr>
