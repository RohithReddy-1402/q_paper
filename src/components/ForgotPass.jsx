...
const ForgotPassword = ({ isForgotOpen, onForgotClose, isLoading, onLoadClose, onLogin, onClose }) => {
  ...
  const changePassword = async () => {
    try {
      ...
      if (password == confpass) {
        const response = await fetch(`${import.meta.env.VITE_BACKEND_ENDPOINT}/resetpassword`, {
          method: "PUT",
  ...
  const verifyOTP = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_ENDPOINT}/otp-verify`, {
        method: "POST",
        headers: { "Content-type": "application/json" },
  ...
  const sendOtp = async () => {
    isLoading();
    const response = await fetch(`${import.meta.env.VITE_BACKEND_ENDPOINT}/forgotpassword`, {
      method: "POST",
      headers: { "Content-type": "application/json" },
